...
vm.lineChartOption = {
    ...
    if (today.getDate() < 10) tDate = '0' + today.getDate();
   ...
   str += "" + tYear + "" + tMonth + "" + tDate; this.$http.get(str).then(function(response) {
